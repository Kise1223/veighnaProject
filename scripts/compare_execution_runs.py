"""Compare two paper/shadow execution runs under M11 execution analytics."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--compare-basis",
        required=True,
        choices=["paper_vs_shadow", "bars_vs_ticks", "full_vs_partial", "day_vs_ioc"],
    )
